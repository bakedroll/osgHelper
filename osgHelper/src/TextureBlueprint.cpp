...
osg::ref_ptr<ITextureBlueprint> TextureBlueprint::image(const osg::ref_ptr<osg::Image>& img)
{
  m->image = img;
...
osg::ref_ptr<ITextureBlueprint> TextureBlueprint::texLayer(int texLayer)
{
  m->texLayer = texLayer;
...
osg::ref_ptr<ITextureBlueprint> TextureBlueprint::assign(const osg::ref_ptr<osg::StateSet>& stateSet)
{
...
osg::ref_ptr<ITextureBlueprint> TextureBlueprint::uniform(const osg::ref_ptr<osg::StateSet>& stateSet, const std::string& uniformName)
{
